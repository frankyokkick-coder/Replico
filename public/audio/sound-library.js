...
const ANIMAL_SOUND_ENTRIES = [
  ...
  sampleEntry('pig_1', 'Pig', 'pig_al_1.mp3'),
  sampleEntry('pig_2', 'Pig', 'pig_al_2.mp3'),
  sampleEntry('pig_3', 'Pig', 'pig_al_3.mp3'),
  ...
  sampleEntry('monkey_1', 'Monkey', 'monkey_al_1.mp3'),
  sampleEntry('monkey_2', 'Monkey', 'monkey_al_2.mp3'),
  sampleEntry('monkey_3', 'Monkey', 'monkey_al_3.mp3'),
