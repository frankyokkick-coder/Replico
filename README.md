...
- **Sounds**: `public/audio/sound-library.js` - 54 sounds total.
  ...
  - Animal sounds are real recordings (not synthesized) in
    ...
    39 real animal clips cover chicken, rooster, horse, dog (regular/
    small/big/howl), cat, cow, sheep, goat, duck, turkey, donkey,
    frog, bird, owl, goose, plus bonus lion/chimp/bear/wolf clips -
    ...
    monkey, or elephant sound: those samples turned out to not be genuine
    recordings of the animal - so they were removed rather than left
    mislabeled.)
